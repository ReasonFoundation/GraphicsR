...
```{r graph, fig.width=7, fig.height=5, fig.align = "center", message=FALSE, warning=FALSE}
### linePlot ###
...
graph <- linePlot(PERSI.data, yaxisMin = -33, yaxisMax = 30, yaxisSeq = 3,
                  yaxisScale = 100, format = "%", str = 20,
