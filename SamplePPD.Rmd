...
## A History of Weakening Solvency (1995-2019) w/ R Code
```{r graph, fig.width=7, fig.height=4, fig.align = "center", message=FALSE, warning=FALSE}
### linePlot ###
...
data$year <- as.numeric(data$year)
  ...
  ggplot2::ggplot(graph, ggplot2::aes(x = year, y = yaxisScale * value, group = variable)) +
    ...
    theme(legend.text=element_text(size=14))+ #Added element to control legend font size
    theme(legend.direction = "vertical", #changing legend direction to "vertical"
                legend.box = "horizontal",
                legend.position= c(0.42, 0.13)) #Moved legend to the bottom
}

graph <- linePlot(PERSI.data, yaxisMin = -27, yaxisMax = 21, yaxisSeq = 3,
...
#                  labelY = "AVA va. AAL", lab1 = "Actuarial Valued of Assets", 
#                  lab2 = "Actuarially Accrued Liabilities")


graph
```
  
## A History of Weakening Solvency (1995-2019) w/ Saved Img
