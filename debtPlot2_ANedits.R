...
############
debtPlot <- function(data, sp500 = TRUE, title = NULL, caption = FALSE, grid = FALSE, ticks = TRUE, font) {
  ...
  if(sp500 == TRUE){
    ...
    funded <- filteredData2(pl, "Idaho Public Employee Retirement System", start_year)
