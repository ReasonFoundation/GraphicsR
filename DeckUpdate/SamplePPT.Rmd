...
graph <- linePlot(PERSI.data, title = NULL, caption = FALSE, grid = FALSE, 
                  treasury = FALSE, inv.returns = TRUE, ticks = TRUE, font = "Calibri",
                  yaxisMin = -21, yaxisMax = 21, yaxisSeq = 3,
