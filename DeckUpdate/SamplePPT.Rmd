...
### Arkansas Data ###
  ...
  #[3] Combine gain/loss data & categories to create interactive Waterfall chart w/ plotly
    x = list(
    "Investment<br>Returns", "Benefit<br>Changes<br> & Other",
      "Changes to<br>Actuarial<br>Methods &<br>Assumptions", 
      "Negative<br>Amortization",
      "Deviations from<br>Demographic<br>Assumptions",
      "Gains From<br>Pay<br>Increases<br>Not Given",
    ...
    fig <- fig %>%
      layout(#title = paste0("<b>Causes of Arkansas ERS Pension Debt<b>"," (2001-2019)"),
    ...
    orca(fig, "GainLoss-plot.png")
    #fig
    
#pen <- png::readPNG("surface-plot.png")
#plot_ly() %>%
#  layout(
#    images = list(
